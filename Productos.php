...
include_once ($_SERVER["DOCUMENT_ROOT"] . '/EfsiTiendaOnline2/dao/CategoriaDao.php');
...
if (isset($_GET['orden'])){
	...
	var_dump($palabraBusquedad);
	var_dump($orden);

	$ArrayProductos = ProductoDao::ObtenerPorFiltros($idCategoria,$palabraBusquedad, $orden);	
	

	$ArrCategorias = CategoriaDao::ObtenerTodos();
			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
							<li class="p-t-4">
								<a href="http://localhost/EfsiTiendaOnline2/Productos.php/?idCategoria=<?php echo $Categoria->idCategoria ?>" class="s-text13 active1">
...
<!--===============================================================================================-->
	<script type="text/javascript" src="vendors/animsition/js/animsition.min.js"></script>
<!--===============================================================================================-->
	<script type="text/javascript" src="vendors/bootstrap/js/popper.js"></script>
